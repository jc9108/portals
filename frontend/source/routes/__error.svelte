<script context="module">
	...
	function ensure_redirect(current_path) {
		(current_path == "/" ? history.pushState(null, "", "/error") : null); // if current path is already index, change the path so that "return to index" will actually redirect to index
	}
...
<div class="text-center mt-5 pt-5">
	...
	<br/>
	<a href="/" class="display-3">return to index</a>
</div>
